...
from tkinter import (ttk, Menu, Spinbox, scrolledtext,
                     filedialog as fd,
                     messagebox as mBox)
...
class OOP():
    ...
    def createWidgets(self):
        ...
        self.check1 = tk.Checkbutton(self.widgetFrame, text=self.i18n.disabled, variable=self.chVarDis,
                                     state='disabled')
        self.check1.select()
        ...
        for col in range(3):
            curRad = 'rad' + str(col)
            curRad = tk.Radiobutton(self.widgetFrame, text=colors[col], variable=self.radVar, value=col,
